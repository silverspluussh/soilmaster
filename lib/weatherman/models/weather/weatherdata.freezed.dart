...
class _$_WeatherParams implements _WeatherParams {
  ...
  @override
  String toString() {
    return 'WeatherParams(temp: $temp, pressure: $pressure, humidity: $humidity, tempmin: $tempmin, tempmax: $tempmax)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, temp, pressure, humidity, tempmin, tempmax);
